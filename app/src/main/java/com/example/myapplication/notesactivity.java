            ...
            protected void onBindViewHolder(@NonNull NoteViewHolder noteViewHolder, int i, @NonNull firebasemodel firebasemodel) {
                ...
                popupbutton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        SpannableString editMenuItem = new SpannableString("Edit");
                        editMenuItem.setSpan(new ForegroundColorSpan(Color.BLACK), 0, editMenuItem.length(), 0);
                        ...
                        popupMenu.getMenu().add("Delete").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                ...
                                SpannableString deleteMenuItem = new SpannableString("Delete");
                                deleteMenuItem.setSpan(new ForegroundColorSpan(Color.BLACK), 0, deleteMenuItem.length(), 0);
